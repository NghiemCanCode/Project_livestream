...
const initWebRoute = (app) => {
    ...
    router.get("/live/:userName", LiveController.getLive)
    ...
    router.post("/createNewUser", AccountValidation.RegisterValidate ,AccountController.createNewUser)
    ...
    router.post('/ForgotPass', AccountController.setForgotPass)
    router.post('/ForgotPassConfirm',AccountController.setForgotPassConfirm)
